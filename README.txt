...
Please copy .ogg files to coresponding /eclipse/assets/sounds/mob/ (blu to pig, badAss to zombie, wolverine to wolf) and copy sounds.json to /eclipse/assets. These file will be used for NPC’s sound.
...
mymod mod, which contains our mod specific items.
