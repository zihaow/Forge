...
/**
 * The ModelWolverine class sets the wolverine's model.
 * @author: Zihao Wu.
 * Version = "1.0a".
 */
...
public class ModelWolverine extends ModelQuadruped{
    ...
    protected float field_78145_g = 7.0F;
    protected float field_78151_h = 5.0F;
    private static final String __OBFID = "CL_00000851";

    public ModelWolverine(int par1, float par2){
      super(par1, par2);
